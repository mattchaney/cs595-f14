...
\lstinputlisting[language=Python, caption={Getting the friends list}, label=listing:get_friends,linerange={37-56},firstnumber=37]{q1/get_friends.py}
...
\lstinputlisting[language=Python, caption={Waiting for API request limit reset}, label=listing:wait,linerange={24-35},firstnumber=24]{q1/get_friends.py}
...
\lstinputlisting[language=Python,caption={Main method}, label=listing:main, linerange={58-81},firstnumber=58]{q1/get_friends.py}
